...
d <- run_sim(bg_param_setting, additional_setting, google_max_cpu, NULL, cores = parallel::detectCores(), write_type = c("charwise", "paramwise", "tracewise"), plot_type = "none", result_loc = "~/Documents/SimulationResult/GoogleData_SimResult/AR1/")
...
d <- run_sim(bg_param_setting, additional_setting, google_max_cpu, google_avg_cpu, cores = parallel::detectCores(), write_type = c("charwise", "paramwise"), plot_type = "none", result_loc = "~/Documents/SimulationResult/GoogleData_SimResult/AR1X/")
