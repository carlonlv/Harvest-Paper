...
plt1 <- ggplot2::ggplot(score_change, ggplot2::aes(x = num_traces_removed, y = score1.n, colour = factor(window_size))) +
...
plt2 <- ggplot2::ggplot(score_change, ggplot2::aes(x = num_traces_removed, y = score2.n, colour = factor(window_size))) +
  ggplot2::geom_path(na.rm = TRUE) +
