...
bg_param_setting <- cbind(bg_param_setting, data.frame(class = "NN", P = 0, granularity = 0, train_policy = "offline", train_size = 2000, update_freq = 3, react_speed = "1,2", extrap_step = 1, stringsAsFactors = FALSE))
