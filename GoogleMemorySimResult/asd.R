...
d <- run_sim(bg_param_setting, additional_setting, google_max_memory, NULL, cores = parallel::detectCores(), write_type = c("charwise", "paramwise"), plot_type = "none", result_loc = "~/Documents/SimulationResult/GoogleMemorySimResult/AR1/")
...
d <- run_sim(bg_param_setting, additional_setting, google_max_memory, google_avg_memory, cores = parallel::detectCores(), write_type = c("charwise", "paramwise"), plot_type = "none", result_loc = "~/Documents/SimulationResult/GoogleMemorySimResult/AR1X/")
...
d <- run_sim(bg_param_setting, additional_setting, google_max_memory, NULL, cores = parallel::detectCores(), write_type = c("charwise", "paramwise"), plot_type = "none", result_loc = "~/Documents/SimulationResult/GoogleMemorySimResult/Markov/")
