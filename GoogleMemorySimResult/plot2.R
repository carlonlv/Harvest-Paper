...
path = "~/Documents/SimulationResult/GoogleMemorySimResult/Markov/"
...
plot_sim_charwise(overall_df,
                  mapping = list("color" = "window_size"),
                  adjusted = FALSE,
                  point_or_line = NA,
                  name = paste0("Markov Model with Google datasets with Granularity ", granularity),
                  path)
