...
schedule_setting <- c("2_jobs", "4_jobs", "1_cores", "2_cores")
window_size <- c(1)
## add 1
...
d <- run_sim(bg_param_setting, additional_setting, microsoft_max_10000, NULL, cores = parallel::detectCores() - 1, write_type = c("paramwise", "charwise"), plot_type = "none", result_loc = "~/Documents/SimulationResult/MultipleorSmallerJobs/")
