...
d <- run_sim(bg_param_setting, additional_setting, microsoft_max_10000, NULL, cores = parallel::detectCores(), write_type = c("paramwise", "charwise"), plot_type = "none", result_loc = "~/Documents/SimulationResult/MultipleorSmallerJobs/")
