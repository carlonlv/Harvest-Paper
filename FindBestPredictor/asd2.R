...
bg_param_setting <- data.frame(class = "ARIMA", name = "AR1", window_size = window_size, granularity = granularity, train_policy = "fixed", train_size = 2000, update_freq = 3, react_speed = "1,2", extrap_step = 1, stringsAsFactors = FALSE)
...
bg_param_setting <- data.frame(class = "MARKOV", name = "Markov", window_size = window_size, granularity = granularity, train_policy = "fixed", train_size = 2000, update_freq = 3, react_speed = "1,2", extrap_step = 1, stringsAsFactors = FALSE)
...
## Adding Averages
bg_param_setting <- data.frame(class = "ARIMA", name = "AR1X(Avg)", window_size = window_size, window_size_for_reg = window_size, window_type_for_reg = "avg", granularity = granularity, train_policy = "fixed", train_size = 2000, update_freq = 3, react_speed = "1,2", extrap_step = 1, stringsAsFactors = FALSE)
...
bg_param_setting <- data.frame(class = "MARKOV", name = "MarkovX(Avg)", window_size = window_size, window_size_for_reg = window_size, window_type_for_reg = "avg", granularity = granularity, train_policy = "fixed", train_size = 2000, update_freq = 3, react_speed = "1,2", extrap_step = 1, stringsAsFactors = FALSE)
...
bg_param_setting <- data.frame(class = "LM", name = "LM(Avg)", window_size = window_size, window_size_for_reg = window_size, window_type_for_reg = "avg", granularity = granularity, train_policy = "fixed", train_size = 2000, update_freq = 3, react_speed = "1,2", extrap_step = 1, stringsAsFactors = FALSE)
...
bg_param_setting <- data.frame(class = "ARIMA", name = "AR1X(Avg.Max12)", window_size = window_size, window_size_for_reg = window_size, window_type_for_reg = "avg", granularity = granularity, train_policy = "fixed", train_size = 2000, update_freq = 3, react_speed = "1,2", extrap_step = 1, stringsAsFactors = FALSE)
...
bg_param_setting <- data.frame(class = "MARKOV", name = "MarkovX(Max12)", window_size = window_size, granularity = granularity, train_policy = "fixed", train_size = 2000, update_freq = 3, react_speed = "1,2", extrap_step = 1, stringsAsFactors = FALSE)
...
bg_param_setting <- data.frame(class = "LM", name = "LM(Avg.Max12)", window_size = window_size, window_size_for_reg = window_size, window_type_for_reg = "avg", granularity = granularity, train_policy = "fixed", train_size = 2000, update_freq = 3, react_speed = "1,2", extrap_step = 1, stringsAsFactors = FALSE)
