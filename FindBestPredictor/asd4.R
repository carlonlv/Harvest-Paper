...
bg_param_setting <- cbind(bg_param_setting,
                          data.frame(class = "VAR", name = "VAR1(max,avg,min,sd,median)", granularity = granularity, train_policy = "fixed", train_size = 1990 * 30, update_freq = 3, react_speed = "1,2", extrap_step = 1, stringsAsFactors = FALSE))
